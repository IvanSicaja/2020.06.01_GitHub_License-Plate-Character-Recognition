...
im1 = Image.open("../main/3.0_Images_of_segmented_cahracters/Cropped_image_1.jpg")
# load dataset
print("#############################################################################")
image_index=0
print("#############################################################################")
...
test= pd.read_csv("../main/4_Segmented_images_converted_in_CSV/image_4_converted_image_in_one_row.csv", index_col=0)
print("#############################################################################")
...
plt.title("Table character image")
plt.imshow(test[image_index][:,:,0])
plt.show()
...
test= pd.read_csv("5.0_Data_for_traning_CNN/A-Z_and_0-9__HandwrittenData_train.csv",index_col=0)
print("#############################################################################")
print("Initial¸test shape is :", test.shape)
print("#############################################################################")
test.head()
