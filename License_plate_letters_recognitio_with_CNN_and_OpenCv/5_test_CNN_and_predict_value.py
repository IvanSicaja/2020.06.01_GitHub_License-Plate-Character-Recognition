...
# load model
model = load_model('5.1_Trained_saved_CNN_models/Model_Batchsize=500__Epoch=60__Accuracy=77.5.h5')
# summarize model.
model.summary()
...
files_counter = os.listdir('3.2_Extended_segmented_images')
print(len(files_counter))

Recognised_character=""

for i in range(len(files_counter)):


    test= pd.read_csv("4_Segmented_images_converted_in_CSV/image_"+str(i+1)+"_converted_image_in_one_row.csv",index_col=0)
    print("#############################################################################")
...
print("################################################################")
print("Recognised characters is ")
print(Recognised_character)
print("################################################################")
print("End of script ;)")
